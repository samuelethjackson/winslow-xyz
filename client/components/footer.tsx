...
const Footer: React.FC<FooterProps> = ({ title }) => {
  ...
  const y = useTransform(scrollYProgress, [0, 0.1], [300, -300]);

  return (
    <footer className="flex flex-col gap-4 px-8 py-4 w-full z-10">
      <motion.div className="h-[80svh] flex flex-col">
        <motion.h1
        style={{ y }}
        >winslow.</motion.h1>
      </motion.div>
      <div className="grid grid-cols-9 grid-rows-1 w-full pt-4 border-t border-black">
